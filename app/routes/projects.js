  ...
  model: function () {
    return [
      ...
      },
      {
        id: "4",
        name: "This Portfolio",
        description: "Portfolio app that contains a welcome page, information about my projects, and my resume.",
      ...
      },
      {
        id: "3",
        name: "Notes",
        description: "Simple note taker with Ember front end and Rails back end",
        url: "http://jaswa-note-taker.herokuapp.com/notes",
        github: "https://github.com/figmentbml/notes",
        skills: ["all custom CSS & HTML", "Ember.js", "Handlebars.js", "Rails API"],
        image: "/assets/Screen Shot notes.png",
        medium: "",
        climate: "",
        climateBadge: "",
        travisCI: "",
